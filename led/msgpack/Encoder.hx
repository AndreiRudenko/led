...
class Encoder {
	...
	static inline var FLOAT_SINGLE_MIN:Float = 1.40129846432481707e-45;
	static inline var FLOAT_SINGLE_MAX:Float = 3.40282346638528860e+38;

	static inline var FLOAT_DOUBLE_MIN:Float = 4.94065645841246544e-324;
	static inline var FLOAT_DOUBLE_MAX:Float = 1.79769313486231570e+308;
		...
		switch (Type.typeof(d)) {
			...
			case TClass(c): {
				switch (Type.getClassName(c)) {
					...
					case "haxe.ds.IntMap" | "haxe.ds.StringMap" | "haxe.ds.UnsafeStringMap" : writeMap(d);
